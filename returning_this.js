/* ********** Our Node Class **********
Recall that Node generates a node for a singly linked list
parameters:
...
Node.prototype.passThis = function(custom_return){  //Add the passThis method to the Node prototype
